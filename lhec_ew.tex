...
uncertainties, beam background related uncertaintes, or possible
small stochastic uncertainties related to the calibration procedure.

Our data samples have originally been simulated 
...
%by high-\Qsq data. 
in which a rather coarse $x$-\Qsq
grid for the simulated data points was chosen (see 
Tab.~\ref{tab:datasets}). Yet, real data may allow a much finer 
binning, in particular at medium $x$ values or at higher \Qsq. 
The effect of a 
finer binning may be simulated to a very good approximation 
by changing the size of the uncorrelated uncertainty. 
In the following we consider alternative scenarios, 
...
factor of two and emulated by choosing the uncorrelated uncertainty 
...
of the thus generated four sets of data samples are summarised 
