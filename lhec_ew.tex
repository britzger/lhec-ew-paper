...
distribution functions, evolved according to the 
...
in \dr\ (see Eq.~(\ref{eq:deltar})) will have to be taken into 
account. For example, assuming $\Delta m_t = 0.5~\GeV$ will 
...
{\color{magenta}
Dicsussion about the scheme, i.e.\ the choice of independent  
parameters. Should appear above, maybe in the previous section? 
}
...
$\Delta \rhop\ = 0.0015$ and $\Delta \kapp\ = 0.0011$, i.e.\ by 
...
Fig.~\ref{fig:sw2eff}. Our estimate for the uncertainties 
