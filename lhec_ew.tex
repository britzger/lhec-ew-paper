...
\begin{figure}[tbp]
  ...
  \caption{
    {\color{red}DB. Check LHeC-50a values in plot. x-axis label (`NC')}
...
\begin{table}[bht!]                                                                                                                                                           
  ...
  \caption{ 
    \rhop{} and \kapp{} fits.
    {\color{red}New table. to be included in text.}
  }
  \label{tab:SM}
\end{table}                                                                                                                                                                   
...
\gf\ and the SM masses from the PDG~\cite{PDG19} we obtain 
...
fit~\cite{Haller:2018nnx,deBlas:2016ojx} and confirms that the 
...
Fig.~\ref{fig:globfit}. Obviously, already other than LHeC data 
are sufficient to provide good constraints on \mW\ and \mt. 
LHeC data probe essentially the same relation of \mW\ and \mt\ 
and they cannot compete with direct measurements of these 
mass parameters. The strength of the LHeC EW analysis is its 
...
PDF determination. LHeC data will offer, for the first time, 
the possibility to study a simultaneous fit of EW and PDF 
parameters. The impact of the latter may be considerably 
reduced if measurents at the LHeC will become available 
\cite{Azzi:2019yne}.
