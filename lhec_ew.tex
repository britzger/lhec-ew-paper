...
interactions, more high-precision electroweak measurements 
...
momentum transfer squared, $Q^2$, came into reach -- an important 
prerequisite for studies of the electroweak interactions in DIS. 
First measurements of electroweak effects at HERA have been 
undertaken in Refs.~\cite{Ahmed:1994fa,Aktas:2005iv} and more 
complete electroweak analyses have been performed only recently,
...
FCC-$eh$~\cite{Abada:2019lih}, and may reach even higher 
center-of-mass energies than the LHeC. At lower energies, the 
planned and approved Electron Ion Collider 
...
of the electroweak interaction, and we will analyze pseudo data 
simulated with different assumptions on the experimental 
uncertainties or the center-of-mass energy. Measurements in the 
regime of spacelike momentum transfer, where the interaction is 
mediated by gauge boson exchange in the $t$-channel, is often 
...
values of $y$ the so-called `mixed' reconstruction
...
Tab.~\ref{tab:datasets}), but real data may allow a much finer 
