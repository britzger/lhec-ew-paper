...
\begin{table}[b!]
  ...
  \begin{tabular}{lccccccc}
    ...
    $\mathcal{L}$ [fb$^{-1}$] & \Qsq\ range [GeV$^2$] & 
    No. of data points \\
    \midrule
    D1 & NC, CC &  7  & $-1$ &  $-0.8$ & 1000 & 5 -- $10^6$ 
       & 100 
    \\ % D4
    D2 & NC, CC &  7  & $-1$ &  $+0.8$ & 10   & 5 -- $10^6$  
       & 100 
    \\ % D8
    D3 & NC, CC &  7  & $+1$ &  $ 0  $ & 10   & 5 -- $10^6$  
       & 100 
    \\ % D7
    D4 & NC, CC &  1  & $-1$ &  $ 0  $ & 1    & 5 -- $10^6$  
       & 100 
    \\ % D5
    \bottomrule
  \end{tabular}
...
\begin{table}[t!]
  ...
  \begin{tabular}{lccc}
    \toprule
    Scenario & $E_e$ & Bin grid  & $\delta_\textrm{unc}$\\
    \midrule
...
\begin{eqnarray}
  ...
  &=& 
  \pm5_{({\rm exp})}\pm8_{({\rm PDF})}\,\MeV  
  =\, 10_{\text{(tot)}}\,\MeV{\rm ~~~~and~~} 
  \\
  \Delta\mW(\text{LHeC-50a}) 
  &=& 
  \pm8_{({\rm exp})}\pm9_{({\rm PDF})}\,\MeV  
  =\, 12_{\text{(tot)}}\,\MeV
\nonumber
\end{eqnarray}
...
\begin{figure}[t!]
  ...
  \caption{
    Left: Determination of the $W$-boson mass from a combined 
...
%
  ...
  \begin{tabular}{cr@{\hskip4pt}lccc}
    \toprule
    Coupling  &  \multicolumn{2}{c}{PDG} & \multicolumn{3}{c}
       {Expected uncertainties} \\
    parameter &  &  & LHeC-60b & LHeC-60a & LHeC-50a \\
    \midrule
    $\au$  & $0.50$   & $^{+0.04}_{-0.05}$   & $0.0015$ & $0.0022$ & $0.0035$ \\
    $\ad$  & $-0.514$ & $^{+0.050}_{-0.029}$ & $0.0034$ & $0.0055$ & $0.0083$ \\
    $\vu$  & $0.18$   & $\pm0.05$            & $0.0010$ & $0.0015$ & $0.0028$ \\
    $\vd$  & $-0.35$  & $^{+0.05}_{-0.06}$   & $0.0027$ & $0.0046$ & $0.0067$ \\
    \midrule
    $\au$  &  \\
    $\vu$  &  \\
    \midrule
...
\begin{figure}[t!]
  ...
  \caption{
    ...
    {\color{red} For LHeC, the experimental and 
    PDF uncertainties are displayed {\em separately? the 
    combination of? Explain!} 
    \\
    {\color{green} Shift label at the x-axis, numbers missing?}
    }
  }
\label{fig:sw2eff}
\end{figure}
