...
%-----------------------------------------------------------------------
\clearpage
\section{Inclusion of LHeC data into global EW fits}
{\color{green}This is a new study. The result is a bit
  disappointing. We may want to put it into an appendix?}
...
\emph{However, the strength of the LHeC EW analysis is in its
  complementarity with measurements in $ee$ or $pp$ or particular
  aspects of EW theory, as for instance light-quark couplings to the $Z$.}
