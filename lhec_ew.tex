...
was obtained from polarised electron-deuteron scattering at SLAC 
...
generically parameterise new physics beyond the SM
In Sec.\,\ref{sec:stu} 
...
predictions are compared to data for unpolarised scattering 
...
summarised in Table\,\ref{tab:scenarios}.
%
\begin{table}[thb!]
  \centering
  \small
 ...
 \end{tabular}
  \caption{
    ...
    electron beam energy, $E_e$, and the assumtions made for
...
data obtained with it. The uncertainties of PDF parametrizations 
...
The $x$-dependence of the PDFs is parametrized at a starting 
...
of the parametrization follows previous LHeC PDF
...
uncertaintes on the PDFs from a pure PDF fit, i.e.\ with fixed 
...
correlated with the normalisation uncertainty of the data, the study
...
of the data with correspondinbly accurate theoretical predictions.
%
