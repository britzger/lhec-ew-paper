...
The realisation of the FCC-$eh$ is in the far future and its 
...
similar as the normalisation uncertainty.
...
whereas the contribution from the NC and CC normalisation,
Eqs.~\eqref{eq:kappaZ-LO} and~\eqref{eq:deltar-NLO}, and from
the $W$-boson propagator term in CC DIS, $\Qsq/(\Qsq+\mw^2)$, cf.\ Eq.~\eqref{eq:cc-cs},
...
dominated by the normalisation uncertainties of the data. Higher 
