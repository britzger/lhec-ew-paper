...
ratios\,\footnote{ 
  ...
  $\Delta m_W / m_W = (\sin^2\theta_W/2\cos^2\theta_W) (\Delta
  \sin^2\theta_W / \sin^2\theta_W)$.
  Therefore a factor of about
  $\sin^2\theta_W/2\cos^2\theta_W \simeq 0.15$
...
{(\color{red}what to discuss first here: uncertainties, or the interpretation?})
%
...
value of \mw\ is compared to direct mass measurements, rather than
...
in table~\ref{tab:rhoCC}. We find that these parameters can be 
...
{\color{red}
  Discuss \rhopW{,f}+\kapp{f}+PDF here. Probably even move
...
to $\pm6\,\MeV$.
This is compatible with a rough estimate of an expected relative
uncertainty, based on simple error propagation, at the level of $10^{-4}$.
