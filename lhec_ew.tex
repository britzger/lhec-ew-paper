...
electroweak physics in a yet completely unexplored kinematic regime of
space-like momentum transfer, {\color{brown}and both, for neutral and charged
current interactions.}

% --- technical summary
In this article we have explored simulated inclusive
neutral-current and charged-current deep-inelastic
scattering (NC and CC DIS) cross
...
\begin{table}[bht!]
  ...
  \caption{
    Standard Model fits 
    {\color{red} Improve caption and repeate scenarios 50a,50b,60a,60b.}
  }
