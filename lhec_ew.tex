...
the range $60\lesssim\sqrt{\Qsq}\lesssim450\,\GeV$.
...
Through the simultaneous analysis of NC and CC DIS data, these three
parameters can be determined indpedendently and uncertainties down to
a few percent will be achieved.

% --- rho kappa
Modifications of the $U(1)\times SU(2)$ gauge structure
...
% --- further tests
The weak neutral-current couplings of fermions can be considered in a
fairly model-independent manner as a free parameter,
and their values can be compared to the expetations from EW theory.
While these couplings are very well known for leptons, the vector and
axial-vector couplings of light quarks, $u$ and $d$, are
experimentally fairly unproven, but LHeC can provide a unique
measurement with permille accuracy of these important quantities.
...
be measured with permille accuracy up to about $\sqrt{\Qsq}\simeq400\,\GeV$.
...
precision electroweak measurement in NC and CC DIS at high scales.
%
...
for experimental studies of charged current interactions.
