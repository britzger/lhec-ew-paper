...
with the PDFs to the inclusive NC/CC DIS data, where the their full set
...
For the determination of the PDFs, NNLO pQCD calculations are used,
and the zero-mass variable flavor number scheme is employed.
...
\end{equation}
where $f$ denotes one of the five linear combinations.
The second summand is considered only for the gluon distribution\footnote{
Although, this term is commonly considered to be of importance for PDF
...
relevance here, and are set to values, as they can be obtained from a fit to HERA
data~\cite{H1dataTodo}. 

EW effects are included into the calculation by considering the full set of 1-loop
...
calculation of the uncertainties, but only the relative size of the uncertainties
are of relevance.
