...
{\color{red} {\em move this to the section for rho-kappa fit: }
In a simultaneous determination 
...
{\color{red} . . . more . . . but we don't show figure or table. }
...
\emph{running} of the effective {\color{red}(?)}
...
% --- rho kappa
Modifications of the $\textrm{U}(1)\times \textrm{SU}(2)$ gauge structure {\color{red}(?)}
...
{\color{blue} Write about what we have NOT done... \\}
...
{\color{brown} 
  Refer to improvement of LHC measurements due to precise LHeC PDFs?
}
...
{\color{brown}
Discuss $\alpha_s$, and its role in EW fit and in DIS, very briefly.
}
