...
The Large Hadron-electron Collider (LHeC) planned at the LHC 
may complement the proton ring with an electron linac, allowing 
to perform deep inelastic scattering (DIS) with electrons and 
protons at TeV energies. Its kinematic reach to higher scales 
in comparison to HERA and the large expected luminosity will 
...
Refs.~\cite{Ahmed:1994fa} {\color{red} \em more!} and a  
final study of electroweak physics with the complete set of 
H1 data was presented in \cite{Spiesberger:2018vki} 
{\color{red} \em  and ZEUS ?}. 

Apart from the LHeC, other options for experimentation with 
DIS are presently studied. A possible Future Circular Collider 
(FCC) could be extended with an electron-hadron part, the FCC-$eh$, 
and further increase the kinematic reach to higher centre of mass 
energies, $\sqrt{s}$. At lower energies, the planned and approved 
Electron Ion Collider (EIC) could extend DIS experiments towards 
...
facilities LHeC, FCC-$eh$, and EIC with the past HERA collider. 
...
document {\color{red} citation?}. Therefore we focus our studies 
in this paper on the potential of a future LHeC collider. Studies 
of electroweak effects for similar energies have been performed
in the past for the LHeC ({\color{red} cite: CDR-2012}) and earlier 
