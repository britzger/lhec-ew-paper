...
\mW, and finally a potential determination of the Higgs-boson mass,
\mH, is discussed. 
...
determine together with the PDFs.
...
calculated as the quadratic difference from the total uncertianty.
...
figure~\ref{fig:mWZ} and compared to the values obtained by
...
experimental uncertainties in a single experiment\,\footnote{In
  figure~\ref{fig:mWZ}, the values from LEP2 and Tevatron represent
...
uncertainties will be needed ({\color{blue}Shall we give/make some
  first estimates here?}).
...
\emph{A complete dependence of the expected total experimental uncertainty
