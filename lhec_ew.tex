...
From the decays of the Higgs boson into fermion pairs,
the LHeC has a direct Higgs mass measurement potential as
well, which surely is much better than the indiect one but
unlikely competitive to that at the LHC through the 4-lepton and 2-photon decays.
...
uncertaities that are common to NC and CC DIS data, mainly the luminosity uncertainty, are
`constrained' by the NC DIS data, and therefore smaller uncertaities
