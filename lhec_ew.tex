...
energy may be chosen to be 60\,GeV, but also be lowered to
a value of 50\,GeV for cost reasons as is discussed in the
forthcoming thorough update of its physics and conceptual 
accelerator and detector design of the LHeC~\cite{Bruning:2706220}. 
...
achieved at HERA and including electron scattering off 
heavier nuclei. For comparison, in Fig.~\ref{fig:dSigmaFacilities} 
...
important, which makes the LHeC and the FCC-eh more favorable 
than the EIC\,\footnote{However, it is 
...
could start taking data in the 2030s. It has recently been 
...
The measurement of SM parameters with high precision is important 
since it allows us to quantify the agreement of data with theory. 
In addition, we will study a number of possible ways to 
generically parameterise new physics beyond the SM and investigate 
...
of 10\,fb$^{-1}$ is assumed for this sample\footnote{This value may actually be  even smaller
 due to the overriding challenge to
generate intense positron beams for use in a linac.}. 
...
the uncertainties are of relevance. We have validated, that the 
...
DIS data. In this initial part of our study we are, in particular, 
...
vice versa, $\Delta\mw = \pm 6$~MeV from the \mw+PDF fit would 
