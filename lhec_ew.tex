...
an additional input to a global EW fit (see e.g.\ Refs.~\cite{deBlas:2016ojx,Haller:2018nnx,PDG19}).
However, once the direct measurements of \mt\ and \mw\ are considered
...
%  Higgs mass
%--------------------------------------------------------
{\color{blue}(This may also go to the appendix) }
...
frequently studied in so-called `global EW fits'~\cite{Haller:2018nnx,deBlas:2016ojx,PDG19}. 
