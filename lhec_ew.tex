...
achieved at HERA. % and including electron scattering off heavier nuclei.
...
%why we focus our studies on the LHeC
%
%
\begin{figure}[t!hb]
  \centering
...
Report on the LHeC. 
%extending its results through more detailed considerations
%of operation scenarios and a novel analysis of the BSM
%physics potential as expressed by the $STU$ parameters.
...
\begin{figure}[thb!]
  \centering
  \includegraphics[width=0.56\textwidth]{plot_GraphsDsigmaDQ2_LHeC}
  \caption{
      Single differential inclusive DIS cross sections for
...
%and are available from Ref.~\cite{MaxHome17,MaxHome19}.
...
of 10\,fb$^{-1}$ is assumed for this sample\footnote{This value may eventually be smaller
 due to difficulties to generate intense positron beams for use in a linac.}. 
...
%mainly for the purpose to
%perform studies of PDF determinations in which
...
\begin{table}[thb!]
 ...
 \end{tabular}
  \caption{
    ...
    referred to by the names shown in the first column. A 
    reduced uncorrelated uncertainty of 0.25\,\% for the 
    'b'-scenarios can be realized by increasing the number of 
    bins with respect to the nominal number of data 
    points given in Tab.~\ref{tab:datasets}. 
  }
  \label{tab:scenarios}
\end{table}


The data implicitly comprise
%can be considered essentially as
a collection of cross 
section ratios. In previous similar studies (see, 
...
extraction procedure to exploit  the corresponding 
information. We can then expect that most of the correlated 
...
a collection of cross section ratios, but while
we do not construct these ratios explicitly, we
leave it to the parameter extraction procedure to exploit
the corresponding information.
It is often informative to consider the..
We can then expect that most of the correlated
uncertainties, such as normalization errors, become largely
constrained by the fit while uncorrelated uncertainties are
reduced by taking the properly weighted average of all data.
As a consequence, due to the large number of data points,
...
\begin{figure}[tb!]
  \centering
  \includegraphics[width=0.48\textwidth]{alphas_summary_W-bosonMass}
  \caption{
...
\begin{figure}[tb!]
  \centering
  \includegraphics[width=0.54\textwidth]{figures/sw2eff}
  \caption{
...
\begin{figure}[tb!]
    \centering
    \includegraphics[width=0.54\textwidth]{plot_lhec_mWmt}
    \caption{
...
\begin{figure}[tb!]
  \centering
  \includegraphics[width=0.32\textwidth,trim=20 0 20 0,clip]{STU_OS/plot_ST}
  \includegraphics[width=0.32\textwidth,trim=20 0 20 0,clip]{STU_OS/plot_SU}
  \includegraphics[width=0.32\textwidth,trim=20 0 20 0,clip]{STU_OS/plot_TU}
  \caption{
...
\begin{figure}[tb!]
  \centering
  \includegraphics[width=0.32\textwidth,trim=20 0 20 0,clip]{STU_MOMS/plot_ST}
  \includegraphics[width=0.32\textwidth,trim=20 0 20 0,clip]{STU_MOMS/plot_SU}
  \includegraphics[width=0.32\textwidth,trim=20 0 20 0,clip]{STU_MOMS/plot_TU}
  \caption{
...
\begin{figure}[tb!]
  \centering
  \includegraphics[width=0.54\textwidth]{plot_rhopWQ2}
  \caption{
...
\begin{figure}[tb!]
 ...
 %\includegraphics[width=0.47\textwidth]{plot_lhec_mWmt_global_1.pdf} 
  \includegraphics[width=0.48\textwidth]{plot_lhec_mWmt_global.pdf} 
  \hskip0.02\textwidth
%  \includegraphics[width=0.47\textwidth]{plot_lhec_mWmt_global_2.pdf} 
  \includegraphics[width=0.48\textwidth]{plot_lhec_mWmt_global_ZOOM.pdf} 
  \caption{
