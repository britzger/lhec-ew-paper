...
weak mixing angle, 
\begin{equation}
  \sin^2 \theta_{W,f}^{\rm eff} (Q^2) = 
  \kappa_{\text{NC}, f}(Q^2) \sw \, . 
\label{eq:sin2w-eff}
\end{equation} 
...
that the $Q^2$ dependence of the effective weak mixing angle 
is not negligible for LHeC phyiscs, while only its value at 
$Q^2 = m_Z^2$ was relevant for $Z$-pole observables. 
...
\hline
  ...
  \caption{
    ...
    from two-parameter+PDF fits. 
    {\color{red} True???}
    The values shown in the second 
...
and $\kappa_\text{NC}^\prime$ parameters, 
{\color{red} i.e., for both the quark and electron couplings}. 
The results are 
...
(see Eq.~(\ref{eq:gV-NLO})). Results for LHeC beam energies 
...
{\color{red} \em write \sw, not leptonic effective \sw\ }
\begin{eqnarray}
...
EW+PDF fit. 
{\color{red} \em Don't keep this: is equivalent to the 
rho-kappa fit described in the previous section.}
}
...
Similar to the determination of non-standard \Qsq-dependent 
couplings in the previous section, one can determine the 
weak mixing angle from subsets of data in different \Qsq-ranges. 
{\color{red} \em New Figure !!} 
If a cacluation of DIS cross sections including higher-order 
...
\begin{figure}[t!]
  ...
  \caption{
    Expected uncertainties of the weak mixing angle as a function of \Qsq. 
    Two scenarios for the simulation of LHeC inclusive NC/CC 
    DIS data are considered. 
  }
\label{fig:sw2Q2}
\end{figure}
...
%  \begin{tabular}{lcr@{$\,\pm\,$}lr@{$\,\pm\,$}lr@{$\,\pm\,$}lr@{$\,\pm\,$}l}
  ...
  \end{tabular}
  \caption{
    Expected relative uncertinaties for the determination of the
    running of $\sin^2\theta_\textrm{W}$ as a function of \Qsq. 
    The values are obtained in a simultaneous fit of all 12 parameters
    of $\sin^2\theta_\textrm{W}(\Qsq)$ and together with the PDF
    parameters at a time.
    In the on-shell scheme the value of $\sin^2\theta_\textrm{W}$
    does not exhibit a \Qsq\ dependence, but these values can be
    translated to other schemes, where a scale dependence is present.
  }
\label{tab:sw2Q2}
\end{table}
...
%    \rhopW{,e\bar{q}}+PDF  & \rhopW{,e\bar{q}}   &  1  &   0.0030  & 1 & 0.0012  & 1 & 0.0012  & 1 & 0.0012 \\
  ...
  {\color{red} Explain the difference between upper and 
  lower two lines: one- or two-parameter fits ???}
  }
\label{tab:rhoCC}
\end{table}
...
%  \begin{tabular}{lcr@{$\,\pm\,$}lr@{$\,\pm\,$}lr@{$\,\pm\,$}lr@{$\,\pm\,$}l}
  \begin{tabular}{lcccccccc}
    ...
    \addlinespace
    S+T+U+PDF  &  S  &  $0.20$ & $0.31$ & $0.46$ & $0.58$ & 1.0 & 0.7 & $-0.4$ \\
               &  T  &  $0.32$ & $0.42$ & $0.52$ & $0.64$ &     & 1.0 & $-0.9$\\
               &  U  &  $0.24$ & $0.30$ & $0.30$ & $0.36$ &     &     & 1.0 \\
    \addlinespace
    S+T+PDF  &  S  & $0.18$ & $0.26$ & $0.35$ & $0.42$ & $1.0$ & $0.98$  \\
             &  T  & $0.09$ & $0.14$ & $0.19$ & $0.23$ &       & $1.0$  \\
    \addlinespace
    S+U+PDF  &  S  & $0.15$ & $0.20$ & $0.22$ & $0.26$ & $1.0$ & & $0.97$  \\
             &  U  & $0.07$ & $0.09$ & $0.11$ & $0.13$ &       & & $1.0$  \\
    \addlinespace
    T+U+PDF  &  T  & $0.24$ & $0.28$ & $0.24$ & $0.28$ & & $1.0$ & $-0.99$  \\
             &  U  & $0.22$ & $0.26$ & $0.22$ & $0.26$ & &       & $1.0$  \\
    \bottomrule
  \end{tabular}
  \caption{
    STU parameters in OMS
  }
  \label{tab:STU_OS}
\end{table}
...
%  \begin{tabular}{lcr@{$\,\pm\,$}lr@{$\,\pm\,$}lr@{$\,\pm\,$}lr@{$\,\pm\,$}l}
  \begin{tabular}{lcccccccc}
    ...
    \addlinespace
    S+T+U+PDF  &  S  &  $0.20$ & $0.32$ & $0.46$ & $0.60$ & 1.00 & 0.98 &$-0.80$ \\
               &  T  &  $0.22$ & $0.35$ & $0.46$ & $0.60$ &     & 1.00 & $-0.87$\\
               &  U  &  $0.11$ & $0.19$ & $0.20$ & $0.27$ &     &     & 1.00 \\
    \addlinespace
    S+T+PDF  &  S  & $0.12$ & $0.20$ & $0.21$ & $0.30$ & $1.00$ & $0.96$  \\
    ...
    T+U+PDF  &  T  & $0.05$ & $0.08$ & $0.06$ & $0.10$ & & $1.00$ & $-0.76$  \\
             &  U  & $0.07$ & $0.11$ & $0.09$ & $0.14$ & &       & $1.00$  \\
    \bottomrule
  \end{tabular}
  \caption{
    STU parameters in MOMS
  }
  \label{tab:STU_OS}
\end{table}
