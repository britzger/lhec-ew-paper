...
for the LEP$\otimes$LHC proposal ({\color{red} cite earlier work}). 
...
self-energy corrections provides a sufficiently precise 
approximation by constant parameters. Taking into account that 
the electromagnetic $U(1)$ gauge symmetry has to stay intact 
and that some of these constants can be absorbed into 
renormalization constants, there are three free parameters, 
generally called $S$, $T$ and $U$~\cite{Peskin:1991sw}. A suitable 
...
\begin{table}[bht!]                                                                                                                                                           
  ...
  \caption{ 
    \rhop{} and \kapp{} fits.
    {\color{red}This new table needs to be referenced in the text.}
  }
  \label{tab:SM}
\end{table}                                                                                                                                                                   
...
\caption{
    Left: Inclusive NC and CC DIS cross sections as a function 
    of \Qsq for two different polarisation states $P=\pm0.8$ and 
    for two different electron beam energies, $E_e=50$ and 
    $60\,\GeV$. For comparison, also the HERA measurements are 
    displayed for $P=0$.
...
\begin{table}[bht!]
  ...
  \begin{tabular}{lcccccc}
    ...
    \addlinespace
    \sweff+PDF   &  \sweff & $10^{-5}$   &  $\pm19$ & $\pm29$ & $\pm31$ & $\pm41$ \\
    \addlinespace
  ...
  \caption{
    Standard Model fits 
    {\color{red} For sw2: check with Eqs.(24,25) ???}
  }
  \label{tab:SM}
\end{table}
...
\begin{table}[htb]
  ...
  \begin{tabular}{lcccccc}
    ...
    $\kappa^\prime_{f}$, $\rho^\prime_{\text{NC},f}$, PDFs
    ...
    $\kappa^\prime_{e}$, $\kappa^\prime_{u}$, $\kappa^\prime_{d}$, PDFs
...
%\hline
  ...
  \caption{
    ...
    $\kappa^\prime_{f}$ parameter is performed instead and
