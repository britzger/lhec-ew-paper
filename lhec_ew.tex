...
these quantum corrections, the determination of \mt\ through these
terms represent an important portal to new physics beyond the SM.
...
Therefore, this measurement provides an important check of the top-quark
mass in EW dominated processes.
Infact, this top-quark mass measurement compares well to \emph{global EW}
fits, where presently uncertainties of $\Delta\mt=2.1\,\GeV$ are
achieved~\cite{Haller:2018nnx} in a fit with further EW parameters.
...
are proportional to $\tfrac{M_t^2}{\mw^2}$ it is reasonable to perform
a a simultaneous determination of \mt\ and \mw.
...
one of the global electroweak fit~\cite{Haller:2018nnx} will be
achieved.

{\color{green} Todo. Discuss/mention the impact of the choice of the
