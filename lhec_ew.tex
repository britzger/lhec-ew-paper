...
Eq.~(\ref{eq:deltar-NLO})). {\color{red} . . . more . . . but we 
don't show figure or table. }
...
electroweak physics {\color{brown}in neutral-current (NC) and
  charged-current (CC) interactions} in a yet completely unexplored kinematic regime of
...
\emph{running} of the effective{\color{red}(?)} weak mixing angle in
...
% mt and mH
{\color{brown}The high precision of the born-level parameters of EW theory also
suggest a determination of} the dominant parameters of the 
...
{\color{red}(?)} may alter in NC interactions the vector and
...
{\color{brown}In contrast, however, LHeC has high sensitivity to
