...
precision in a yet largely unexplored kinematic regime of 
...
$\Delta \sweff = \pm 0.00015$, and also its scale dependence
can be studied in the energy range between about $25$ and 
$700\,\GeV$.
%
{\color{brown} This is equivalent to an indirect determination 
of the $W$-boson mass} with an experimental uncertainty down to 
$\Delta\mW=\pm6\,\MeV$. 
%
We discuss how 
{\color{brown} the uncertainties of such measurements in 
deep-inelastic scattering 
compare with those of} measurements in the timelike domain, 
e.g.\ at the $Z$-pole, and 
{\color{brown} which aspects of the electroweak interaction 
are unique to measurements at the LHeC,} for instance electroweak 
parameters in charged-current interactions.
%
