...
\newcommand{\sweff}{\ensuremath{\sin^2\theta_{\textrm{W},f}^\textrm{eff}}} % (\mz^2)
...
\begin{center}
  Daniel Britzger\,$^1$ and Hubert Spiesberger\,$^{2,3}$ \\
\vspace{0.5cm}
\it
$^1$~~Max-Planck-Institut f{\"u}r Physik, F{\"o}hringer Ring 6, 80805 M{\"u}nchen, Germany \\
$^2$~~Universit{\"a}t Mainz, ... , Germany\\
$^3$~~MITP , ... ,  Germany 
\end{center}
...
%
We exploit simulated inclusive deep-inelastic lepton proton 
scattering at center-of-mass energies of 1.2 and 1.3\,\TeV 
covering a large range of four-momentum transer squared up to 
$\Qsq \simeq 500\,000\,\GeVsq$ with a total integrated luminosity 
of 1\,ab$^{-1}$. The data are equivalent to a large number of 
...
%
We demonstrate that an indirect determination of the $W$-boson 
mass is possible with an uncertainty down to $\Delta\mW=6\,\MeV$. 
The weak mixing angle and its scale dependence can be determined 
with a precision of about $\Delta \sin^2 \theta_W = 0.00015$. 
%
...
\begin{center} To be submitted to EPJ C \end{center}
