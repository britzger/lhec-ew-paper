...
\begin{center}
  Daniel Britzger\,$^1$ and Hubert Spiesberger\,$^{2}$ \\
\vspace{0.5cm}
\it
$^1$~~Max-Planck-Institut f{\"u}r Physik, F{\"o}hringer Ring 6, D-80805 M{\"u}nchen, Germany \\
$^2$~~PRISMA$^+$ Cluster of Excellence, Institut f{\"u}r Physik, Johannes-Gutenberg-Universit{\"a}t, 
...
where electroweak interactions can be studied with a very high precision
in a yet largely unexplored kinematic regime of 
spacelike momentum transfer. 
%
We exploit simulated inclusive neutral- and charged-current deep-inelastic lepton proton 
scattering cross section data at center-of-mass energies of 1.2 and 1.3\,\TeV.
%  in terms of their sensitivity to parameters of electroweak theory.
%covering a large range of four-momentum transer squared up to
%$\Qsq \simeq 500\,000\,\GeVsq$ with a total integrated luminosity 
%of 1\,ab$^{-1}$.
%The data are equivalent to a large number of 
%neutral- and charged-current cross section ratios including 
%scattering with positrons as well as with polarized electrons. 
% 
Based on simultaneous fits of electroweak physics parameters and parton distribution 
functions, we estimate the uncertainties of Standard Model parameters
as well as a number of parameters describing physics beyond the
Standard Model, for instance on the oblique parameters $STU$.
%
%We discsuss the relation of the size of the resulting uncertainties on
%the electroweak parameters to different expectations of the
%uncertainties of the LHeC cross section data, and to LHeC
%scenarios at different center-of-mass energies.
%
...
light-quarks to the $Z$ boson, $g_{A/V}^{u/d}$, improving their present precision 
by more than an order of magnitude.
%
We find that an indirect determination of the $W$-boson 
mass is possible with an experimental uncertainty down to $\Delta\mW=\pm6\,\MeV$. 
The weak mixing angle can be determined with a precision of about
$\Delta \sin^2 \theta_W = \pm0.00015$, and also its scale dependence
can be studied in the energy range between about $25$ and $700\,\GeV$.
%
We discuss how such measurements in deep-inelastic scattering can be compared to 
measurements in the timelike domain, e.g.\ at the $Z$-pole, and which further
particular aspects of electroweak theory can be uniquely probed at the
LHeC, for instance electroweak parameters in charged current interactions.
%
We conclude, that LHeC data will complement with a high experimental
precision the determination of electroweak physics parameters from
other past or ongoing experiments.
