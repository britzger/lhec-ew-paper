...
\begin{center}
\begin{Large}
{\bf Prospects for the determination of electroweak parameters with LHeC inclusive DIS data}
\end{Large}
\end{center}
...
The proposed future electron-proton collider experiment LHeC will
measure inclusive neutral current and charged current deep-inelastic
scattering cross sections at a center-or-mass energy of
$\sqrt{s}=1.3\,\TeV$ and  with a high integrated luminosity of up to
1\,ab$^{-1}$.
%
The unprecedented precision of the data and the large amount of data
at a scale significantly above the electroweak scale will allow for
precise tests of electroweak interactions with inclusive DIS data.
%
In this article, the sensitivity of inclusive neutral current and
charged current DIS cross sections to electroweak parameters is
studied. 
%
With LHeC data unprecedented precsion is achieved fo
...
\item Discuss about $\kappa_Z$ determination
\item finalise paper
\end{itemize}
