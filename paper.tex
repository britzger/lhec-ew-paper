...
\begin{abstract}
\noindent
The proposed electron-proton collider experiment LHeC will
measure inclusive neutral current and charged current deep-inelastic
scattering cross sections at a center-of-mass energy of
$\sqrt{s}=1.2\,\TeV$ or 1.3\,\TeV and  with a high integrated
luminosity of up to 1\,ab$^{-1}$.
%
The sensitivity of inclusive DIS cross sections to the 
determination of electroweak parameters is studied. 
%
The unprecedented precision of the data and the large amount of data
at a scale significantly above the electroweak scale will allow one 
to perform high-precision tests of the electroweak interactions.
